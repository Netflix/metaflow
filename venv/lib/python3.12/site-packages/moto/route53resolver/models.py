...
class Route53ResolverBackend(BaseBackend):
    ...
    def __init__(self, region_name: str, account_id: str):
        ...
        self.resolver_endpoints: dict[str, ResolverEndpoint] = (
            {}
        )  # Key is self-generated ID (endpoint_id)
        self.resolver_rules: dict[str, ResolverRule] = (
            {}
        )  # Key is self-generated ID (rule_id)
        self.resolver_rule_associations: dict[str, ResolverRuleAssociation] = (
            {}
        )  # Key is resolver_rule_association_id)
        self.resolver_query_log_configs: dict[str, ResolverQueryLogConfig] = (
            {}
        ...
        self.resolver_dnssec_configs: dict[str, ResolverDnssecConfig] = (
            {}
        )  # Key is resource_id
