    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if self.replication_subnet_group_identifier:
            subnet_group = {
                ...
                "SupportedNetworkTypes": (
                    [self.network_type] if self.network_type else ["IPV4"]
                ),
            }
        ...
        return {
            ...
            "ReplicationInstancePublicIpAddress": (
                self.public_ip_addresses[0] if self.public_ip_addresses else None
            ),
            "ReplicationInstancePrivateIpAddress": (
                self.private_ip_addresses[0] if self.private_ip_addresses else None
            ),
            ...
            "SecondaryAvailabilityZone": (
                f"{self.availability_zone}b" if self.multi_az else None
            ),
            "FreeUntil": None,
