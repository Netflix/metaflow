...
class GreengrassBackend(BaseBackend):
    ...
    def create_device_definition_version(
        ...
        self.device_definitions[device_definition_id].latest_version = (
            device_ver.version
        )
        self.device_definitions[device_definition_id].latest_version_arn = (
            device_ver.arn
        )
    ...
    def create_resource_definition_version(
        ...
        self.resource_definitions[resource_definition_id].latest_version = (
            resource_def_ver.version
        )

        self.resource_definitions[resource_definition_id].latest_version_arn = (
            resource_def_ver.arn
        )
    ...
    def create_function_definition_version(
        ...
        self.function_definitions[function_definition_id].latest_version = (
            func_ver.version
        )
        self.function_definitions[function_definition_id].latest_version_arn = (
            func_ver.arn
        )
