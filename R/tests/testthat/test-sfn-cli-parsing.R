test_that("SFN create", {
  ...
  expected <- "--flowRDS=flow.RDS step-functions create" 
...
test_that("SFN create --help", {
  ...
  expected <- "--flowRDS=flow.RDS step-functions create --help" 
...
test_that("SFN create --generate-new-token", {
  ...
  expected <- "--flowRDS=flow.RDS step-functions create --generate-new-token" 
...
test_that("SFN create --generate-new-token --max-workers 100 --lr 0.01", {
  ...
  expected <- "--flowRDS=flow.RDS step-functions create --generate-new-token --max-workers 100 --lr 0.01" 
...
test_that("SFN trigger", {
  ...
  expected <- "--flowRDS=flow.RDS step-functions trigger" 
...
test_that("SFN list-runs --running", {
  ...
  expected <- "--flowRDS=flow.RDS step-functions list-runs --running" 
