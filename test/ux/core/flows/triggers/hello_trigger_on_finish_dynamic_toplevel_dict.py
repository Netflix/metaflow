...
class TriggerOnFinishFlowDynamicTopLevelDictFlow(FlowSpec):
    ...
    def start(self):
        ...
        print("In TriggerOnFinishFlowDynamicTopLevelDictFlow")
...
if __name__ == "__main__":
    TriggerOnFinishFlowDynamicTopLevelDictFlow()
