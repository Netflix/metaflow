...
## We'll be using pandas for most of our steps, so let's make it part of our base.
@conda_base(libraries={'pandas' : '0.25.3'})
class XORFlow(FlowSpec):
    ...
    ## We'll be using roc_auc_score to evaluate our models, so we'll import sklearn for this step.
    @conda(libraries={'scikit-learn': '0.22'})
    @step
    def end(self):
        """
