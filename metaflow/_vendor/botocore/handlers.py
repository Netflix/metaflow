...
from metaflow._vendor.botocore.compat import (
    unquote, json, six, unquote_str, ensure_bytes, get_md5,
    MD5_AVAILABLE, OrderedDict, urlsplit, urlunsplit, XMLParseError,
    ETree,
)
from metaflow._vendor.botocore.docs.utils import AutoPopulatedParam
from metaflow._vendor.botocore.docs.utils import HideParamFromOperations
from metaflow._vendor.botocore.docs.utils import AppendParamDocumentation
from metaflow._vendor.botocore.signers import add_generate_presigned_url
from metaflow._vendor.botocore.signers import add_generate_presigned_post
from metaflow._vendor.botocore.signers import add_generate_db_auth_token
from metaflow._vendor.botocore.exceptions import ParamValidationError
from metaflow._vendor.botocore.exceptions import AliasConflictParameterError
from metaflow._vendor.botocore.exceptions import UnsupportedTLSVersionWarning
from metaflow._vendor.botocore.exceptions import MissingServiceIdError
from metaflow._vendor.botocore.utils import percent_encode, SAFE_CHARS
from metaflow._vendor.botocore.utils import switch_host_with_param
from metaflow._vendor.botocore.utils import hyphenize_service_id
from metaflow._vendor.botocore.utils import conditionally_calculate_md5

from metaflow._vendor.botocore import retryhandler
from metaflow._vendor.botocore import utils
from metaflow._vendor.botocore import translate
from metaflow._vendor import botocore
