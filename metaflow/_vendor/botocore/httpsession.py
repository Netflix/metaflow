...
from metaflow._vendor.urllib3 import PoolManager, ProxyManager, proxy_from_url, Timeout
from metaflow._vendor.urllib3.util.retry import Retry
from metaflow._vendor.urllib3.util.ssl_ import (
    ssl, OP_NO_SSLv2, OP_NO_SSLv3, OP_NO_COMPRESSION, DEFAULT_CIPHERS,
)
from metaflow._vendor.urllib3.exceptions import SSLError as URLLib3SSLError
from metaflow._vendor.urllib3.exceptions import ReadTimeoutError as URLLib3ReadTimeoutError
from metaflow._vendor.urllib3.exceptions import ConnectTimeoutError as URLLib3ConnectTimeoutError
from metaflow._vendor.urllib3.exceptions import NewConnectionError, ProtocolError, ProxyError
try:
    # Always import the original SSLContext, even if it has been patched
    from metaflow._vendor.urllib3.contrib.pyopenssl import orig_util_SSLContext as SSLContext
except ImportError:
    from metaflow._vendor.urllib3.util.ssl_ import SSLContext

import botocore.awsrequest
from metaflow._vendor.botocore.vendored import six
from metaflow._vendor.botocore.vendored.six.moves.urllib_parse import unquote
from metaflow._vendor.botocore.compat import filter_ssl_warnings, urlparse
...
try:
    from metaflow._vendor.certifi import where
except ImportError:
    def where():
