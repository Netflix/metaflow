...
from metaflow._vendor.botocore.exceptions import MD5UnavailableError
from metaflow._vendor.dateutil.tz import tzlocal
from metaflow._vendor.urllib3 import exceptions

logger = logging.getLogger(__name__)


if six.PY3:
    from metaflow._vendor.botocore.vendored.six.moves import http_client
...
def get_tzinfo_options():
    ...
    if sys.platform == 'win32':
        from metaflow._vendor.dateutil.tz import tzwinlocal
