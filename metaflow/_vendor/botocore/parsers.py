...
from metaflow._vendor.botocore.compat import six, ETree, XMLParseError
from metaflow._vendor.botocore.eventstream import EventStream, NoInitialResponseError

from metaflow._vendor.botocore.utils import parse_timestamp, merge_dicts, \
