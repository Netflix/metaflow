...
from metaflow._vendor.setuptools.extern.packaging.version import Version, InvalidVersion
from metaflow._vendor.setuptools.extern.packaging.specifiers import SpecifierSet
...
def read_configuration(filepath, find_others=False, ignore_option_errors=False):
    ...
    :rtype: dict
    """
    from metaflow._vendor.setuptools.dist import Distribution, _Distribution
...
class ConfigOptionsHandler(ConfigHandler):
    ...
    def _parse_packages(self, value):
        ...
        if findns:
            from metaflow._vendor.setuptools import find_namespace_packages as find_packages
        else:
            from metaflow._vendor.setuptools import find_packages
