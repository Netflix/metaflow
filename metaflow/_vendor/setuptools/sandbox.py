...
from metaflow._vendor.pkg_resources import working_set
...
class UnpickleableException(Exception):
    ...
    def dump(type, exc):
        ...
        try:
            ...
            from metaflow._vendor.setuptools.sandbox import UnpickleableException as cls
...
class DirectorySandbox(AbstractSandbox):
    ...
    def _violation(self, operation, *args, **kw):
        from metaflow._vendor.setuptools.sandbox import SandboxViolation
