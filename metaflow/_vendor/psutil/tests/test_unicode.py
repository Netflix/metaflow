...
from metaflow._vendor.psutil.tests import INVALID_UNICODE_SUFFIX
from metaflow._vendor.psutil.tests import PYPY
from metaflow._vendor.psutil.tests import TESTFN_PREFIX
...
if APPVEYOR:
    ...
    def safe_rmpath(path):  # NOQA
        ...
        from metaflow._vendor.psutil.tests import safe_rmpath as rm
