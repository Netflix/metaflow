...
from metaflow._vendor.psutil._compat import which
...
from metaflow._vendor.psutil.tests import PY3
...
if WINDOWS:
    from metaflow._vendor.psutil._pswindows import convert_oserror
