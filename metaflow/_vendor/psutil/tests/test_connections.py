...
from metaflow._vendor.psutil.tests import AF_UNIX
from metaflow._vendor.psutil.tests import HAS_NET_CONNECTIONS_UNIX
from metaflow._vendor.psutil.tests import SKIP_SYSCONS
...
from metaflow._vendor.psutil.tests import check_connection_ntuple
...
class TestSystemWideConnections(ConnectionTestCase):
    ...
    def test_it(self):
        ...
        with create_sockets():
            from metaflow._vendor.psutil._common import conn_tmap
