...
DEFAULT_DATAPROVIDER = from_conf('METAFLOW_DEFAULT_DATAPROVIDER', '')
...
DEFAULT_SUFFIXES = from_conf('METAFLOW_DEFAULT_SUFFIXES', '.py,.R,.RDS')
DEFAULT_AWS_CLIENT_PROVIDER = from_conf('METAFLOW_DEFAULT_AWS_CLIENT_PROVIDER', 'aws')
