...
ARGO_WORKFLOWS_NOTIFY_ON_ERROR = from_conf("ARGO_EVENTS_NOTIFY_ON_ERROR", False)
ARGO_WORKFLOWS_NOTIFY_ON_SUCCESS = from_conf("ARGO_EVENTS_NOTIFY_ON_SUCCESS", False)
