...
if __name__ == "__main__":
    ...
    cmds = [
        ...
        if ! command -v micromamba >/dev/null 2>&1; then
            mkdir micromamba;
            python -c "import requests, bz2, sys; data = requests.get('https://micro.mamba.pm/api/micromamba/{architecture}/1.5.7-0').content; sys.stdout.buffer.write(bz2.decompress(data))" | tar -xv -C $(pwd)/micromamba bin/micromamba --strip-components 1;
