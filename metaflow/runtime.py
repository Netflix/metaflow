...
class SpinRuntime(object):
    ...
    def input_paths(self):
        ...
        if self._step_func.name == self._graph.start_step:
...
class NativeRuntime(object):
    ...
    def persist_constants(self, task_id=None):
        ...
        # Register start/end step metadata so the client can determine
        # graph endpoints without loading _graph_info.
    ...
    def execute(self):
        if len(self._cloned_tasks) > 0:
            ...
            first_step = self._graph.start_step
